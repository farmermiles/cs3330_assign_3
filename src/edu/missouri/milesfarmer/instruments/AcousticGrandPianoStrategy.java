...
/**
 * A concrete strategy to change the instrument to acoustic grand piano.
 */
public class AcousticGrandPianoStrategy implements InstrumentStrategy {
    /**
     * Apply this the acoustic grand piano instrument to the given channel on the given track.
